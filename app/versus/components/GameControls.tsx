...
const GameControls: React.FC<GameControlsProps> = ({
  ...
  return (
    <>
      ...
      <div className=" z-50 w-[calc(100%-2rem)]">
        <div className=" rounded-lg border-2 border-gray-300 shadow px-4 py-3 text-gray-800">
          <div className="flex justify-between items-center border-b border-gray-200 pb-2 mb-2">
            <span className="font-bold text-blue-700 truncate mr-2">
              {playerName || "You"}
            </span>
      ...
      <div className=" z-50 flex flex-row gap-2">
        <button
          className=" rounded-lg border-2 border-gray-300 shadow flex items-center justify-center w-10 h-10 hover:bg-gray-100"
        ...
        <button
          className=" rounded-lg border-2 border-gray-300 shadow hidden md:flex items-center justify-center w-10 h-10 hover:bg-gray-100 relative"
        ...
        >
          ...
          {/* Shortcuts tooltip */}
          {showShortcuts && (
            <div className=" bg-gray-800 text-white text-sm rounded-lg p-3 whitespace-nowrap shadow-lg z-60 hidden md:block">
              ...
              <div className="space-y-1">
                ...
                <div>
                  <span className="font-mono bg-gray-700 px-1 rounded">W</span>A
                  <span className="font-mono bg-gray-700 px-1 rounded">S</span>D
                  - Pan map
                </div>
                <div>
                  <span className="font-mono bg-gray-700 px-1 rounded">1</span>-
                  <span className="font-mono bg-gray-700 px-1 rounded">3</span>{" "}
                  - Zoom levels
                </div>
              </div>
      ...
      */}
      <div className="w-full px-4 left-0">
        <button
          onClick={onSubmit}
