...
Write-ColorOutput "   1. Update your Vercel environment variable:" ""
Write-ColorOutput "      NEXT_PUBLIC_WEBSOCKET_URL=http://$($instanceInfo.PublicIp):3001" "Green"
Write-ColorOutput "   2. Test your multiplayer functionality" ""
Write-ColorOutput "   3. Monitor logs: ssh to server and run 'docker-compose logs -f'" ""
Write-ColorOutput "" ""
