...
# Copy to EC2
Write-Host "Copying script to EC2..." -ForegroundColor Blue
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "Make sure your SSH key is in the secrets/ directory" -ForegroundColor Yellow
}

# Cleanup
Remove-Item "setup-ssl.sh" -Force -ErrorAction SilentlyContinue
