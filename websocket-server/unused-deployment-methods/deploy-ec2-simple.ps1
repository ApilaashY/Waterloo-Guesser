...
function New-SecurityGroup {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        # WebSocket access
        aws ec2 authorize-security-group-ingress --group-id $sgId --protocol tcp --port 3001 --cidr 0.0.0.0/0 --region $Region
...
Write-ColorOutput "   Instance ID: $($instanceInfo.InstanceId)" "White"
Write-ColorOutput "   Public IP: $($instanceInfo.PublicIp)" "White"
Write-ColorOutput "   Instance Type: $InstanceType" "White"
...
Write-ColorOutput "   1. Update your Vercel environment variable:" "White"
Write-ColorOutput "      NEXT_PUBLIC_WEBSOCKET_URL=http://$($instanceInfo.PublicIp):3001" "Green"
Write-ColorOutput "   2. Test your multiplayer functionality" "White"
Write-ColorOutput "   3. Monitor logs: ssh to server and run 'docker-compose logs -f'" "White"
Write-ColorOutput "" "White"
