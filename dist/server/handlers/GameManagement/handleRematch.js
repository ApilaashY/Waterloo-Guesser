export async function handleRematch(socket, io, sessionId, socketId, gameRooms) {
    ...
    if (game.rematchRequested.player1 && game.rematchRequested.player2) {
        ...
        // Clear the room close timeout
        game.clearRoomCloseTimeout();
        // Reset game state
        ...
        // Notify spectators
        io.to(`spectator:${sessionId}`).emit("spectatorRoundStart", game.getSpectatorView());
