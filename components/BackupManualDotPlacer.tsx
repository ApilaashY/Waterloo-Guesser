//   // Import floorplan_lookup.json
//   const floorplans = require("../floorplan_lookup.json");
//   // Group floorplans by building
//   const buildingFloors: Record<string, Array<{ filename: string; floor: string }>> = {};
//   floorplans.forEach((fp: any) => {
//     if (!fp.building || fp.building === "UNKNOWN") return;
//     if (!buildingFloors[fp.building]) buildingFloors[fp.building] = [];
//     buildingFloors[fp.building].push({ filename: fp.filename, floor: fp.floor });
//   });
