...
interface TriangleImagePreviewProps {
  triangleImages: Array<{ image: string; id: string; correctX: number; correctY: number; records: any }>;
...
export default function TriangleImagePreview({
  triangleImages,
  currentImageIndex,
  ...
  // Dynamic container style - now includes space for triangle navigation
      ...
      >
        ...
        >
          <CldImage
            ...
            width={imgW}
            height={imgH}
            alt={`Campus location - Vertex ${currentImageIndex + 1}`}
            ...
            style={{
              ...
              opacity: flashVisible ? 1 : 0, // Handle flash modifier
            }}
