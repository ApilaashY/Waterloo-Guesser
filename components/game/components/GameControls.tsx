          ...
          {showShortcuts && (
            <div className="absolute left-12 top-0 bg-gray-800 text-white text-sm rounded-lg p-3 whitespace-nowrap shadow-lg z-60 hidden md:block">
              ...
              <div className="space-y-1">
                ...
                <div>
                  <span className="font-mono bg-gray-700 px-1 rounded">Q</span>,{" "}
                  <span className="font-mono bg-gray-700 px-1 rounded">E</span>,{" "}
                  <span className="font-mono bg-gray-700 px-1 rounded">Z</span>,{" "}
                  <span className="font-mono bg-gray-700 px-1 rounded">C</span>{" "}
                  - Snap to corners
                </div>
                <div>
